...
from .course import CoursesManager, Course, CourseButton, CourseButtonType, Test, Subscription, CourseInnerButton
...
class DataBase(ParamsManager, UsersDB, ActivityTracker, CoursesManager, Statistic):
